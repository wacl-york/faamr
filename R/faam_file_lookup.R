...
faam_file_lookup = function(){
  ...
  tibble::tribble(
    ...
    "core-nitrates.nc",            "core-nitrates_faam(.*?).nc",                   "read_faam_nitrates",
    "core-nitrates_faam_raw.zip",  "core-nitrates_faam(.*?)raw.zip",               NA, 
    "core-thermistor.nc",         "core-thermistor_faam(.*?).nc",                  NA, 
    "faam-ccnrack.nc",             "faam-ccnrack_faam_(.*?).nc",                   NA,
    "faam-fgga.na",                "faam-fgga_faam(.*?).na",                       "read_faam_fgga",
    ...
    "faam-dropsonde_proc.nc",      "faam-dropsonde_faam(.*?)proc.nc",              NA,
    "flight-sum.csv",              "flight-sum_faam(.*?).csv",                     NA,
    "flight-cst.yaml",             "flight-cst_faam(.*?).yaml",                    NA, 
    "flight-cst.txt",              "flight-cst_faam(.*?).txt",                     "read_flight_summary",
    ...
    "man-ams.na",                  "man-ams_faam(.*?).na",                         NA,
    "man-sp2.na",                  "man-sp2_faam(.*?).na",                         NA,
    "man-tildas.na",               "man-tildas_faam(.*?).na",                      NA,
